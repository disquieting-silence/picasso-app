...
$c_Ltutorial_webapp_TutorialApp$.prototype.calculatePercent__Ltutorial_webapp_puzzle_Canvas__Ltutorial_webapp_puzzle_Canvas__I = (function(user, solution) {
  var this$1 = user.Ltutorial_webapp_puzzle_Canvas__f_grid;
  var this$2 = $as_sci_List($f_sc_StrictOptimizedIterableOps__zipWithIndex__O(this$1));
  var acc = 0;
  ...
  while ((!these.isEmpty__Z())) {
    ...
    matchEnd4: {
      ...
      var acc$1 = $uI(x1.T2__f__2);
      if ((p2 !== null)) {
        var row = $as_sci_List(p2._1__O());
        var rowId = p2._2$mcI$sp__I();
        var this$3 = $as_sci_List($f_sc_StrictOptimizedIterableOps__zipWithIndex__O(row));
        var acc$2 = 0;
        var these$1 = this$3.reverse__sci_List();
        while ((!these$1.isEmpty__Z())) {
          var arg1$1 = these$1.head__O();
          var arg2$1 = acc$2;
          var x0$2 = $as_T2(arg1$1);
          var x1$2 = $uI(arg2$1);
          var x1$3 = $ct_T2__O__O__(new $c_T2(), x0$2, x1$2);
          matchEnd4$1: {
            var p2$1 = $as_T2(x1$3.T2__f__1);
            var acc2 = $uI(x1$3.T2__f__2);
            if ((p2$1 !== null)) {
              var cell = $as_Ltutorial_webapp_puzzle_Color(p2$1._1__O());
              var colId = p2$1._2$mcI$sp__I();
              var this$4 = solution.Ltutorial_webapp_puzzle_Canvas__f_grid;
              var this$5 = $as_sc_LinearSeqOps($f_sc_LinearSeqOps__apply__I__O(this$4, rowId));
              var x$2 = $f_sc_LinearSeqOps__apply__I__O(this$5, colId);
              var numCorrect = (cell === x$2);
              acc$2 = (numCorrect ? ((1 + acc2) | 0) : acc2);
              break matchEnd4$1
            };
  ...
  var overallCorrect = $uI(acc);
  $m_jl_System$Streams$().jl_System$Streams$__f_out.println__T__V(("overall: " + overallCorrect));
  var a = (100.0 * ((overallCorrect + 0.0) / $imul(user.Ltutorial_webapp_puzzle_Canvas__f_numAcross, user.Ltutorial_webapp_puzzle_Canvas__f_numDown)));
  return $doubleToInt($uD(Math.ceil(a)))
});
$c_Ltutorial_webapp_TutorialApp$.prototype.setupUI__V = (function() {
  var heading = $m_Ltutorial_webapp_ui_Heading$().make__Ltutorial_webapp_ui_Heading__T__Lorg_scalajs_dom_raw_Element(new $c_Ltutorial_webapp_ui_Heading(1), "Picasso");
  heading.classList.add("banner");
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body.appendChild(heading);
  var elem = $m_s_None$();
  ...
  var grid = $m_Ltutorial_webapp_ui_Grid$().make__I__I__F1__Ltutorial_webapp_ui_Grid(this.Ltutorial_webapp_TutorialApp$__f_solution.Ltutorial_webapp_puzzle_Canvas__f_numDown, this.Ltutorial_webapp_TutorialApp$__f_solution.Ltutorial_webapp_puzzle_Canvas__f_numAcross, new $c_sjsr_AnonFunction1(((this$4, hackyGrid$1, hackyPalette$1, hackyProgress$1) => ((x0$1$2) => {
    ...
    if ((x0$1 !== null)) {
      ...
      var colNum = x0$1._2$mcI$sp__I();
      var $$x1 = $m_Ltutorial_webapp_TutorialApp$();
      var qual$1 = $m_Ltutorial_webapp_TutorialApp$().Ltutorial_webapp_TutorialApp$__f_state;
      var x$1 = $m_Ltutorial_webapp_puzzle_Canvas$().setColor__Ltutorial_webapp_puzzle_Canvas__T2__Ltutorial_webapp_puzzle_Color__Ltutorial_webapp_puzzle_Canvas($m_Ltutorial_webapp_TutorialApp$().Ltutorial_webapp_TutorialApp$__f_state.Ltutorial_webapp_state_State__f_user, new $c_T2$mcII$sp(rowNum, colNum), $m_Ltutorial_webapp_TutorialApp$().Ltutorial_webapp_TutorialApp$__f_state.Ltutorial_webapp_state_State__f_activeColor);
  ...
  container.appendChild(grid.Ltutorial_webapp_ui_Grid__f_container);
  var outerContainer = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("div");
...
/** @constructor */
function $c_Ltutorial_webapp_alien_DomUtils$() {
  /*<skip>*/
}
$c_Ltutorial_webapp_alien_DomUtils$.prototype = new $h_O();
$c_Ltutorial_webapp_alien_DomUtils$.prototype.constructor = $c_Ltutorial_webapp_alien_DomUtils$;
/** @constructor */
function $h_Ltutorial_webapp_alien_DomUtils$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_alien_DomUtils$.prototype = $c_Ltutorial_webapp_alien_DomUtils$.prototype;
$c_Ltutorial_webapp_alien_DomUtils$.prototype.getAttribute__Lorg_scalajs_dom_raw_Element__T__s_Option = (function(elm, name) {
  var raw = $as_T(elm.getAttribute(name));
  $m_jl_System$Streams$().jl_System$Streams$__f_out.println__T__V(("raw: " + raw));
  return (((raw !== null) && (raw !== "")) ? new $c_s_Some(raw) : $m_s_None$())
});
var $d_Ltutorial_webapp_alien_DomUtils$ = new $TypeData().initClass({
  Ltutorial_webapp_alien_DomUtils$: 0
}, false, "tutorial.webapp.alien.DomUtils$", {
  Ltutorial_webapp_alien_DomUtils$: 1,
  O: 1
});
$c_Ltutorial_webapp_alien_DomUtils$.prototype.$classData = $d_Ltutorial_webapp_alien_DomUtils$;
var $n_Ltutorial_webapp_alien_DomUtils$;
function $m_Ltutorial_webapp_alien_DomUtils$() {
  if ((!$n_Ltutorial_webapp_alien_DomUtils$)) {
    $n_Ltutorial_webapp_alien_DomUtils$ = new $c_Ltutorial_webapp_alien_DomUtils$()
  };
  return $n_Ltutorial_webapp_alien_DomUtils$
}
function $is_Ltutorial_webapp_puzzle_Color(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Ltutorial_webapp_puzzle_Color)))
}
function $as_Ltutorial_webapp_puzzle_Color(obj) {
  return (($is_Ltutorial_webapp_puzzle_Color(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "tutorial.webapp.puzzle.Color"))
}
function $isArrayOf_Ltutorial_webapp_puzzle_Color(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ltutorial_webapp_puzzle_Color)))
}
function $asArrayOf_Ltutorial_webapp_puzzle_Color(obj, depth) {
  return (($isArrayOf_Ltutorial_webapp_puzzle_Color(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ltutorial.webapp.puzzle.Color;", depth))
}
/** @constructor */
function $c_Ltutorial_webapp_puzzle_Color$() {
  /*<skip>*/
}
$c_Ltutorial_webapp_puzzle_Color$.prototype = new $h_O();
$c_Ltutorial_webapp_puzzle_Color$.prototype.constructor = $c_Ltutorial_webapp_puzzle_Color$;
/** @constructor */
function $h_Ltutorial_webapp_puzzle_Color$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_puzzle_Color$.prototype = $c_Ltutorial_webapp_puzzle_Color$.prototype;
$c_Ltutorial_webapp_puzzle_Color$.prototype.getAll__sci_List = (function() {
  $m_sci_List$();
  var array = [$m_Ltutorial_webapp_puzzle_Black$(), $m_Ltutorial_webapp_puzzle_Red$(), $m_Ltutorial_webapp_puzzle_Blue$(), $m_Ltutorial_webapp_puzzle_Green$(), $m_Ltutorial_webapp_puzzle_White$(), $m_Ltutorial_webapp_puzzle_Yellow$(), $m_Ltutorial_webapp_puzzle_Pink$(), $m_Ltutorial_webapp_puzzle_Purple$(), $m_Ltutorial_webapp_puzzle_Orange$(), $m_Ltutorial_webapp_puzzle_Cyan$(), $m_Ltutorial_webapp_puzzle_Brown$(), $m_Ltutorial_webapp_puzzle_MultiColor$()];
  var elems = new $c_sjsr_WrappedVarArgs(array);
  return $m_sci_Nil$().prependedAll__sc_IterableOnce__sci_List(elems)
});
$c_Ltutorial_webapp_puzzle_Color$.prototype.identify__T__s_Option = (function(colorString) {
  $m_jl_System$Streams$().jl_System$Streams$__f_out.println__T__V(("identifying :  " + colorString));
  var this$2 = this.getAll__sci_List();
  var these = this$2;
  while ((!these.isEmpty__Z())) {
    var arg1 = these.head__O();
    var c = $as_Ltutorial_webapp_puzzle_Color(arg1);
    var this$3 = c.toString__T();
    if ((colorString === $as_T(this$3.toLowerCase()))) {
...
var $d_Ltutorial_webapp_puzzle_Color$ = new $TypeData().initClass({
  Ltutorial_webapp_puzzle_Color$: 0
}, false, "tutorial.webapp.puzzle.Color$", {
  Ltutorial_webapp_puzzle_Color$: 1,
  O: 1
});
$c_Ltutorial_webapp_puzzle_Color$.prototype.$classData = $d_Ltutorial_webapp_puzzle_Color$;
var $n_Ltutorial_webapp_puzzle_Color$;
function $m_Ltutorial_webapp_puzzle_Color$() {
  if ((!$n_Ltutorial_webapp_puzzle_Color$)) {
...
$c_Ltutorial_webapp_ui_Palette$.prototype = new $h_O();
$c_Ltutorial_webapp_ui_Palette$.prototype.constructor = $c_Ltutorial_webapp_ui_Palette$;
/** @constructor */
function $h_Ltutorial_webapp_ui_Palette$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_ui_Palette$.prototype = $c_Ltutorial_webapp_ui_Palette$.prototype;
$c_Ltutorial_webapp_ui_Palette$.prototype.renderColour__Ltutorial_webapp_puzzle_Color__Lorg_scalajs_dom_raw_Element = (function(color) {
  var col = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("div");
  $m_sci_List$();
  var this$1 = color.toString__T();
  var array = ["color", ("color-" + $as_T(this$1.toLowerCase()))];
  var elems = new $c_sjsr_WrappedVarArgs(array);
  ...
  var this$7 = color.toString__T();
  col.setAttribute("data-color", $as_T(this$7.toLowerCase()));
  return col
});
$c_Ltutorial_webapp_ui_Palette$.prototype.extractColor__sci_List__Lorg_scalajs_dom_raw_Element__s_Option = (function(colors, targetElement) {
  var colorOfEl = $as_T(targetElement.getAttribute("data-color"));
  if ((colorOfEl !== "")) {
    var these = colors;
    while ((!these.isEmpty__Z())) {
      var arg1 = these.head__O();
      var c = $as_Ltutorial_webapp_puzzle_Color(arg1);
      var this$3 = c.toString__T();
      if ((colorOfEl === $as_T(this$3.toLowerCase()))) {
        return new $c_s_Some(these.head__O())
      };
      these = $as_sci_List(these.tail__O())
    };
...
$c_Ltutorial_webapp_ui_Palette$.prototype.getAllItems__Lorg_scalajs_dom_raw_Element__sci_List = (function(paletteElement) {
  var all = paletteElement.querySelectorAll("[data-color]");
  var list = new $c_scm_ListBuffer();
  $m_jl_System$Streams$().jl_System$Streams$__f_out.println__T__V(("list: " + $uI(all.length)));
  var end = $uI(all.length);
  var isEmpty = (end < 0);
  if ((!isEmpty)) {
    var i = 0;
    while (true) {
      var v1 = i;
      var x1 = all[v1];
      if ($uZ((x1 instanceof Element))) {
        var this$7 = $m_Ltutorial_webapp_alien_DomUtils$().getAttribute__Lorg_scalajs_dom_raw_Element__T__s_Option(x1, "data-color");
        var optEntry;
        if (this$7.isEmpty__Z()) {
          optEntry = $m_s_None$()
        } else {
          var arg1 = this$7.get__O();
          var colorString = $as_T(arg1);
          var this$8 = $m_Ltutorial_webapp_puzzle_Color$().identify__T__s_Option(colorString);
          if (this$8.isEmpty__Z()) {
            optEntry = $m_s_None$()
          } else {
            var arg1$1 = this$8.get__O();
            var color = $as_Ltutorial_webapp_puzzle_Color(arg1$1);
            optEntry = new $c_s_Some($ct_T2__O__O__(new $c_T2(), x1, color))
          }
        };
        if ((!optEntry.isEmpty__Z())) {
          var arg1$2 = optEntry.get__O();
          var e = $as_T2(arg1$2);
          list.addOne__O__scm_ListBuffer(e)
        }
      };
      if ((i === end)) {
        break
  ...
  return list.toList__sci_List()
});
$c_Ltutorial_webapp_ui_Palette$.prototype.setActiveColor__Lorg_scalajs_dom_raw_Element__Ltutorial_webapp_puzzle_Color__V = (function(paletteElement, activeColor) {
  var candidates = this.getAllItems__Lorg_scalajs_dom_raw_Element__sci_List(paletteElement);
  $m_jl_System$Streams$().jl_System$Streams$__f_out.println__T__V(("candidates: " + candidates));
  var these = candidates;
  while ((!these.isEmpty__Z())) {
    var arg1 = these.head__O();
    var x0$1 = $as_T2(arg1);
    if ((x0$1 !== null)) {
      var elm = x0$1._1__O();
      var color = $as_Ltutorial_webapp_puzzle_Color(x0$1._2__O());
...
$c_Ltutorial_webapp_ui_Palette$.prototype.renderPalette__sci_List__F1__Lorg_scalajs_dom_raw_Element = (function(colors, onChooseColor) {
  ...
  var f = ((this$1) => ((color$2) => {
    var color = $as_Ltutorial_webapp_puzzle_Color(color$2);
    return $m_Ltutorial_webapp_ui_Palette$().renderColour__Ltutorial_webapp_puzzle_Color__Lorg_scalajs_dom_raw_Element(color)
  }))(this);
  var all;
  if ((colors === $m_sci_Nil$())) {
    all = $m_sci_Nil$()
  } else {
    var arg1 = colors.head__O();
    var h = new $c_sci_$colon$colon(f(arg1), $m_sci_Nil$());
    var t = h;
    var rest = $as_sci_List(colors.tail__O());
  ...
  while ((!these.isEmpty__Z())) {
    ...
    div.appendChild(arg1$2);
    these = $as_sci_List(these.tail__O())
  };
  div.addEventListener("click", ((colors$1, onChooseColor$1) => ((arg1$2$1) => {
    $m_Ltutorial_webapp_ui_Palette$().tutorial$webapp$ui$Palette$$$anonfun$renderPalette$3__Lorg_scalajs_dom_raw_Event__sci_List__F1__V(arg1$2$1, colors$1, onChooseColor$1)
  }))(colors, onChooseColor));
  return div
});
$c_Ltutorial_webapp_ui_Palette$.prototype.tutorial$webapp$ui$Palette$$$anonfun$renderPalette$3__Lorg_scalajs_dom_raw_Event__sci_List__F1__V = (function(evt, colors$1, onChooseColor$1) {
  var target = evt.target;
  if ($uZ((target instanceof Element))) {
    var this$2 = $m_Ltutorial_webapp_ui_Palette$().extractColor__sci_List__Lorg_scalajs_dom_raw_Element__s_Option(colors$1, target);
    if ((!this$2.isEmpty__Z())) {
      var arg1 = this$2.get__O();
      var color = $as_Ltutorial_webapp_puzzle_Color(arg1);
      onChooseColor$1.apply__O__O(color)
    }
  }
});
var $d_Ltutorial_webapp_ui_Palette$ = new $TypeData().initClass({
  Ltutorial_webapp_ui_Palette$: 0
}, false, "tutorial.webapp.ui.Palette$", {
  Ltutorial_webapp_ui_Palette$: 1,
  O: 1
});
$c_Ltutorial_webapp_ui_Palette$.prototype.$classData = $d_Ltutorial_webapp_ui_Palette$;
var $n_Ltutorial_webapp_ui_Palette$;
function $m_Ltutorial_webapp_ui_Palette$() {
  if ((!$n_Ltutorial_webapp_ui_Palette$)) {
    $n_Ltutorial_webapp_ui_Palette$ = new $c_Ltutorial_webapp_ui_Palette$()
  };
  return $n_Ltutorial_webapp_ui_Palette$
}
...
/** @constructor */
function $c_Ltutorial_webapp_puzzle_Canvas$() {
  /*<skip>*/
}
$c_Ltutorial_webapp_puzzle_Canvas$.prototype = new $h_O();
$c_Ltutorial_webapp_puzzle_Canvas$.prototype.constructor = $c_Ltutorial_webapp_puzzle_Canvas$;
/** @constructor */
function $h_Ltutorial_webapp_puzzle_Canvas$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_puzzle_Canvas$.prototype = $c_Ltutorial_webapp_puzzle_Canvas$.prototype;
$c_Ltutorial_webapp_puzzle_Canvas$.prototype.clear__Ltutorial_webapp_puzzle_Canvas__Ltutorial_webapp_puzzle_Canvas = (function(canvas) {
  var this$3 = canvas.Ltutorial_webapp_puzzle_Canvas__f_grid;
  var f$1 = ((this$1) => ((g$2) => {
    ...
    if ((g === $m_sci_Nil$())) {
      ...
      var h = new $c_sci_$colon$colon(f(arg1), $m_sci_Nil$());
      var t = h;
      var rest = $as_sci_List(g.tail__O());
      while ((rest !== $m_sci_Nil$())) {
        var arg1$1 = rest.head__O();
        var nx = new $c_sci_$colon$colon(f(arg1$1), $m_sci_Nil$());
        t.sci_$colon$colon__f_next = nx;
  ...
  var x$2 = canvas.Ltutorial_webapp_puzzle_Canvas__f_numAcross;
  var x$3 = canvas.Ltutorial_webapp_puzzle_Canvas__f_numDown;
  return new $c_Ltutorial_webapp_puzzle_Canvas(x$2, x$3, x$1$1)
});
$c_Ltutorial_webapp_puzzle_Canvas$.prototype.setColor__Ltutorial_webapp_puzzle_Canvas__T2__Ltutorial_webapp_puzzle_Color__Ltutorial_webapp_puzzle_Canvas = (function(canvas, coord, newColor) {
  var this$1 = canvas.Ltutorial_webapp_puzzle_Canvas__f_grid;
  var this$5 = $as_sci_List($f_sc_StrictOptimizedIterableOps__zipWithIndex__O(this$1));
  var f$1 = ((this$2, coord$1, newColor$1) => ((x0$1$2) => {
    var x0$1 = $as_T2(x0$1$2);
    if ((x0$1 !== null)) {
      var row = $as_sci_List(x0$1._1__O());
      var rowId = x0$1._2$mcI$sp__I();
      if ((row !== null)) {
        if ((rowId === coord$1._1$mcI$sp__I())) {
          var this$4 = $as_sci_List($f_sc_StrictOptimizedIterableOps__zipWithIndex__O(row));
          var f = ((this$3, coord$1$1, newColor$1$1) => ((x0$2$2) => {
            var x0$2 = $as_T2(x0$2$2);
            if ((x0$2 !== null)) {
              var existingColor = $as_Ltutorial_webapp_puzzle_Color(x0$2._1__O());
              var cellId = x0$2._2$mcI$sp__I();
              if ((existingColor !== null)) {
                return ((cellId === coord$1$1._2$mcI$sp__I()) ? newColor$1$1 : existingColor)
              }
            };
            throw new $c_s_MatchError(x0$2)
          }))(this$2, coord$1, newColor$1);
          if ((this$4 === $m_sci_Nil$())) {
            return $m_sci_Nil$()
          } else {
...
var $d_Ltutorial_webapp_puzzle_Canvas$ = new $TypeData().initClass({
  ...
  Ltutorial_webapp_puzzle_Canvas$: 1,
  O: 1,
  Ljava_io_Serializable: 1
});
$c_Ltutorial_webapp_puzzle_Canvas$.prototype.$classData = $d_Ltutorial_webapp_puzzle_Canvas$;
var $n_Ltutorial_webapp_puzzle_Canvas$;
function $m_Ltutorial_webapp_puzzle_Canvas$() {
  if ((!$n_Ltutorial_webapp_puzzle_Canvas$)) {
    $n_Ltutorial_webapp_puzzle_Canvas$ = new $c_Ltutorial_webapp_puzzle_Canvas$()
  };
  return $n_Ltutorial_webapp_puzzle_Canvas$
}
function $p_Ltutorial_webapp_ui_Grid$__renderCell__Lorg_scalajs_dom_raw_Element__Ltutorial_webapp_puzzle_Color__V($thiz, cell, color) {
  var this$1 = color.toString__T();
  cell.setAttribute("data-color", $as_T(this$1.toLowerCase()))
}
/** @constructor */
...
/** @constructor */
function $h_Ltutorial_webapp_ui_Grid$() {
  /*<skip>*/
}
  ...
  while ((!these.isEmpty__Z())) {
    ...
    matchEnd5: {
      if ((x0$1 !== null)) {
        ...
        var rowId = x0$1._2$mcI$sp__I();
        if ((row !== null)) {
          var this$2 = $as_sci_List($f_sc_StrictOptimizedIterableOps__zipWithIndex__O(row));
          var these$1 = this$2;
          while ((!these$1.isEmpty__Z())) {
            var arg1$1 = these$1.head__O();
            var x0$2 = $as_T2(arg1$1);
            matchEnd5$1: {
              if ((x0$2 !== null)) {
                var cell = $as_Ltutorial_webapp_puzzle_Color(x0$2._1__O());
                var cellId = x0$2._2$mcI$sp__I();
                if ((cell !== null)) {
                  var this$3 = grid.Ltutorial_webapp_ui_Grid__f_cells;
                  var this$4 = $as_sc_LinearSeqOps($as_T2($f_sc_LinearSeqOps__apply__I__O(this$3, rowId))._2__O());
                  var element = $f_sc_LinearSeqOps__apply__I__O(this$4, cellId);
                  $p_Ltutorial_webapp_ui_Grid$__renderCell__Lorg_scalajs_dom_raw_Element__Ltutorial_webapp_puzzle_Color__V($m_Ltutorial_webapp_ui_Grid$(), element, cell);
                  break matchEnd5$1
                }
              };
              throw new $c_s_MatchError(x0$2)
...
$c_Ltutorial_webapp_ui_Grid$.prototype.extractCoords__Lorg_scalajs_dom_raw_Element__s_Option = (function(cell) {
  var this$1 = $m_Ltutorial_webapp_alien_DomUtils$().getAttribute__Lorg_scalajs_dom_raw_Element__T__s_Option(cell, "data-row");
  var this$5;
  if (this$1.isEmpty__Z()) {
    this$5 = $m_s_None$()
  } else {
    ...
    var x$1 = $as_T(arg1);
    var this$4 = $m_jl_Integer$();
    this$5 = new $c_s_Some(this$4.parseInt__T__I__I(x$1, 10))
  };
  if (this$5.isEmpty__Z()) {
    ...
    var row = $uI(arg1$1);
    var this$6 = $m_Ltutorial_webapp_alien_DomUtils$().getAttribute__Lorg_scalajs_dom_raw_Element__T__s_Option(cell, "data-column");
    var this$10;
    if (this$6.isEmpty__Z()) {
      ...
      this$10 = new $c_s_Some(this$9.parseInt__T__I__I(x$2, 10))
    };
    if (this$10.isEmpty__Z()) {
      return $m_s_None$()
    } else {
      var arg1$3 = this$10.get__O();
      var cell$1 = $uI(arg1$3);
      return new $c_s_Some(new $c_T2$mcII$sp(row, cell$1))
    }
  }
});
$c_Ltutorial_webapp_ui_Grid$.prototype.make__I__I__F1__Ltutorial_webapp_ui_Grid = (function(numRows, numCols, onPaint) {
  var table = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("table");
  var tbody = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("tbody");
  table.appendChild(tbody);
  tbody.addEventListener("click", ((onPaint$1) => ((arg1$2) => {
...
$c_Ltutorial_webapp_ui_Grid$.prototype.tutorial$webapp$ui$Grid$$$anonfun$make$1__Lorg_scalajs_dom_raw_Event__F1__V = (function(e, onPaint$1) {
  var target = e.target;
  if ($uZ((target instanceof Element))) {
    var this$2 = $m_Ltutorial_webapp_ui_Grid$().extractCoords__Lorg_scalajs_dom_raw_Element__s_Option(target);
    if ((!this$2.isEmpty__Z())) {
      var arg1 = this$2.get__O();
      var coords = $as_T2(arg1);
      onPaint$1.apply__O__O(coords)
    }
  }
});
var $d_Ltutorial_webapp_ui_Grid$ = new $TypeData().initClass({
  Ltutorial_webapp_ui_Grid$: 0
}, false, "tutorial.webapp.ui.Grid$", {
  Ltutorial_webapp_ui_Grid$: 1,
  O: 1,
  Ljava_io_Serializable: 1
});
$c_Ltutorial_webapp_ui_Grid$.prototype.$classData = $d_Ltutorial_webapp_ui_Grid$;
var $n_Ltutorial_webapp_ui_Grid$;
function $m_Ltutorial_webapp_ui_Grid$() {
  if ((!$n_Ltutorial_webapp_ui_Grid$)) {
    $n_Ltutorial_webapp_ui_Grid$ = new $c_Ltutorial_webapp_ui_Grid$()
  };
  return $n_Ltutorial_webapp_ui_Grid$
}
/** @constructor */
function $c_Ltutorial_webapp_ui_Heading$() {
  /*<skip>*/
}
$c_Ltutorial_webapp_ui_Heading$.prototype = new $h_O();
$c_Ltutorial_webapp_ui_Heading$.prototype.constructor = $c_Ltutorial_webapp_ui_Heading$;
/** @constructor */
function $h_Ltutorial_webapp_ui_Heading$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_ui_Heading$.prototype = $c_Ltutorial_webapp_ui_Heading$.prototype;
$c_Ltutorial_webapp_ui_Heading$.prototype.make__Ltutorial_webapp_ui_Heading__T__Lorg_scalajs_dom_raw_Element = (function(level, text) {
  var h = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement(("h" + level.Ltutorial_webapp_ui_Heading__f_level));
  h.textContent = text;
  return h
});
var $d_Ltutorial_webapp_ui_Heading$ = new $TypeData().initClass({
  Ltutorial_webapp_ui_Heading$: 0
}, false, "tutorial.webapp.ui.Heading$", {
  Ltutorial_webapp_ui_Heading$: 1,
  O: 1,
  Ljava_io_Serializable: 1
});
$c_Ltutorial_webapp_ui_Heading$.prototype.$classData = $d_Ltutorial_webapp_ui_Heading$;
var $n_Ltutorial_webapp_ui_Heading$;
function $m_Ltutorial_webapp_ui_Heading$() {
  if ((!$n_Ltutorial_webapp_ui_Heading$)) {
    $n_Ltutorial_webapp_ui_Heading$ = new $c_Ltutorial_webapp_ui_Heading$()
  };
  return $n_Ltutorial_webapp_ui_Heading$
}
/** @constructor */
function $c_Ltutorial_webapp_ui_ProgressBar$() {
  /*<skip>*/
}
$c_Ltutorial_webapp_ui_ProgressBar$.prototype = new $h_O();
$c_Ltutorial_webapp_ui_ProgressBar$.prototype.constructor = $c_Ltutorial_webapp_ui_ProgressBar$;
/** @constructor */
function $h_Ltutorial_webapp_ui_ProgressBar$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_ui_ProgressBar$.prototype = $c_Ltutorial_webapp_ui_ProgressBar$.prototype;
$c_Ltutorial_webapp_ui_ProgressBar$.prototype.setValue__Ltutorial_webapp_ui_ProgressBar__I__V = (function(pb, value) {
  pb.Ltutorial_webapp_ui_ProgressBar__f_bar.setAttribute("style", (("width: " + value) + "%"))
});
$c_Ltutorial_webapp_ui_ProgressBar$.prototype.make__Ltutorial_webapp_ui_ProgressBar = (function() {
  var container = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("div");
  container.classList.add("progressbar");
  var bar = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("div");
  bar.classList.add("progress");
  container.appendChild(bar);
  return new $c_Ltutorial_webapp_ui_ProgressBar(container, bar)
});
var $d_Ltutorial_webapp_ui_ProgressBar$ = new $TypeData().initClass({
  Ltutorial_webapp_ui_ProgressBar$: 0
}, false, "tutorial.webapp.ui.ProgressBar$", {
  Ltutorial_webapp_ui_ProgressBar$: 1,
  O: 1,
  Ljava_io_Serializable: 1
});
$c_Ltutorial_webapp_ui_ProgressBar$.prototype.$classData = $d_Ltutorial_webapp_ui_ProgressBar$;
var $n_Ltutorial_webapp_ui_ProgressBar$;
function $m_Ltutorial_webapp_ui_ProgressBar$() {
  if ((!$n_Ltutorial_webapp_ui_ProgressBar$)) {
    $n_Ltutorial_webapp_ui_ProgressBar$ = new $c_Ltutorial_webapp_ui_ProgressBar$()
  };
  return $n_Ltutorial_webapp_ui_ProgressBar$
}
...
function $f_sc_StrictOptimizedIterableOps__zipWithIndex__O($thiz) {
  ...
  var it = $thiz.iterator__sc_Iterator();
  while (it.hasNext__Z()) {
    var elem = $ct_T2__O__O__(new $c_T2(), it.next__O(), i);
...
/** @constructor */
function $c_Ltutorial_webapp_puzzle_Canvas(numAcross, numDown, grid) {
  this.Ltutorial_webapp_puzzle_Canvas__f_numAcross = 0;
  this.Ltutorial_webapp_puzzle_Canvas__f_numDown = 0;
  this.Ltutorial_webapp_puzzle_Canvas__f_grid = null;
  this.Ltutorial_webapp_puzzle_Canvas__f_numAcross = numAcross;
  this.Ltutorial_webapp_puzzle_Canvas__f_numDown = numDown;
  this.Ltutorial_webapp_puzzle_Canvas__f_grid = grid
}
$c_Ltutorial_webapp_puzzle_Canvas.prototype = new $h_O();
$c_Ltutorial_webapp_puzzle_Canvas.prototype.constructor = $c_Ltutorial_webapp_puzzle_Canvas;
/** @constructor */
...
$h_Ltutorial_webapp_puzzle_Canvas.prototype = $c_Ltutorial_webapp_puzzle_Canvas.prototype;
$c_Ltutorial_webapp_puzzle_Canvas.prototype.productPrefix__T = (function() {
  return "Canvas"
});
$c_Ltutorial_webapp_puzzle_Canvas.prototype.productArity__I = (function() {
  return 3
});
$c_Ltutorial_webapp_puzzle_Canvas.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.Ltutorial_webapp_puzzle_Canvas__f_numAcross;
      break
    }
    case 1: {
      return this.Ltutorial_webapp_puzzle_Canvas__f_numDown;
      break
    }
    case 2: {
      return this.Ltutorial_webapp_puzzle_Canvas__f_grid;
      break
    }
    default: {
...
$c_Ltutorial_webapp_puzzle_Canvas.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1(this)
});
$c_Ltutorial_webapp_puzzle_Canvas.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  var hash = acc;
  var data = $f_T__hashCode__I("Canvas");
  acc = $m_sr_Statics$().mix__I__I__I(hash, data);
  var hash$1 = acc;
  var data$1 = this.Ltutorial_webapp_puzzle_Canvas__f_numAcross;
  acc = $m_sr_Statics$().mix__I__I__I(hash$1, data$1);
  var hash$2 = acc;
  var data$2 = this.Ltutorial_webapp_puzzle_Canvas__f_numDown;
  acc = $m_sr_Statics$().mix__I__I__I(hash$2, data$2);
  var hash$3 = acc;
  var x = this.Ltutorial_webapp_puzzle_Canvas__f_grid;
...
$c_Ltutorial_webapp_puzzle_Canvas.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$()._toString__s_Product__T(this)
});
$c_Ltutorial_webapp_puzzle_Canvas.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ((x$1 instanceof $c_Ltutorial_webapp_puzzle_Canvas)) {
    var Canvas$1 = $as_Ltutorial_webapp_puzzle_Canvas(x$1);
    if (((this.Ltutorial_webapp_puzzle_Canvas__f_numAcross === Canvas$1.Ltutorial_webapp_puzzle_Canvas__f_numAcross) && (this.Ltutorial_webapp_puzzle_Canvas__f_numDown === Canvas$1.Ltutorial_webapp_puzzle_Canvas__f_numDown))) {
      var x = this.Ltutorial_webapp_puzzle_Canvas__f_grid;
      var x$2 = Canvas$1.Ltutorial_webapp_puzzle_Canvas__f_grid;
...
function $as_Ltutorial_webapp_puzzle_Canvas(obj) {
  return (((obj instanceof $c_Ltutorial_webapp_puzzle_Canvas) || (obj === null)) ? obj : $throwClassCastException(obj, "tutorial.webapp.puzzle.Canvas"))
}
function $isArrayOf_Ltutorial_webapp_puzzle_Canvas(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ltutorial_webapp_puzzle_Canvas)))
}
function $asArrayOf_Ltutorial_webapp_puzzle_Canvas(obj, depth) {
  return (($isArrayOf_Ltutorial_webapp_puzzle_Canvas(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ltutorial.webapp.puzzle.Canvas;", depth))
}
var $d_Ltutorial_webapp_puzzle_Canvas = new $TypeData().initClass({
  Ltutorial_webapp_puzzle_Canvas: 0
}, false, "tutorial.webapp.puzzle.Canvas", {
...
$c_Ltutorial_webapp_puzzle_Canvas.prototype.$classData = $d_Ltutorial_webapp_puzzle_Canvas;
/** @constructor */
function $c_Ltutorial_webapp_state_State(user, solution, activeColor) {
  this.Ltutorial_webapp_state_State__f_user = null;
  this.Ltutorial_webapp_state_State__f_solution = null;
  this.Ltutorial_webapp_state_State__f_activeColor = null;
  this.Ltutorial_webapp_state_State__f_user = user;
  this.Ltutorial_webapp_state_State__f_solution = solution;
  this.Ltutorial_webapp_state_State__f_activeColor = activeColor
}
$c_Ltutorial_webapp_state_State.prototype = new $h_O();
$c_Ltutorial_webapp_state_State.prototype.constructor = $c_Ltutorial_webapp_state_State;
/** @constructor */
function $h_Ltutorial_webapp_state_State() {
  /*<skip>*/
}
$h_Ltutorial_webapp_state_State.prototype = $c_Ltutorial_webapp_state_State.prototype;
$c_Ltutorial_webapp_state_State.prototype.productPrefix__T = (function() {
  return "State"
});
$c_Ltutorial_webapp_state_State.prototype.productArity__I = (function() {
  return 3
});
$c_Ltutorial_webapp_state_State.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.Ltutorial_webapp_state_State__f_user;
      break
    }
    case 1: {
      return this.Ltutorial_webapp_state_State__f_solution;
      break
    }
    case 2: {
      return this.Ltutorial_webapp_state_State__f_activeColor;
      break
    }
    default: {
      return $m_sr_Statics$().ioobe__I__O(x$1)
...
$c_Ltutorial_webapp_state_State.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1(this)
});
$c_Ltutorial_webapp_state_State.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__Z__I(this, (-889275714), false)
});
$c_Ltutorial_webapp_state_State.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$()._toString__s_Product__T(this)
});
$c_Ltutorial_webapp_state_State.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ((x$1 instanceof $c_Ltutorial_webapp_state_State)) {
    var State$1 = $as_Ltutorial_webapp_state_State(x$1);
    var x = this.Ltutorial_webapp_state_State__f_user;
    var x$2 = State$1.Ltutorial_webapp_state_State__f_user;
    var $$x1;
    if (((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))) {
      var x$3 = this.Ltutorial_webapp_state_State__f_solution;
      var x$4 = State$1.Ltutorial_webapp_state_State__f_solution;
      $$x1 = ((x$3 === null) ? (x$4 === null) : x$3.equals__O__Z(x$4))
    } else {
      $$x1 = false
    };
    if ($$x1) {
      var x$5 = this.Ltutorial_webapp_state_State__f_activeColor;
      var x$6 = State$1.Ltutorial_webapp_state_State__f_activeColor;
      return (x$5 === x$6)
    } else {
      return false
    }
...
function $as_Ltutorial_webapp_state_State(obj) {
  return (((obj instanceof $c_Ltutorial_webapp_state_State) || (obj === null)) ? obj : $throwClassCastException(obj, "tutorial.webapp.state.State"))
}
function $isArrayOf_Ltutorial_webapp_state_State(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ltutorial_webapp_state_State)))
}
function $asArrayOf_Ltutorial_webapp_state_State(obj, depth) {
  return (($isArrayOf_Ltutorial_webapp_state_State(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ltutorial.webapp.state.State;", depth))
}
var $d_Ltutorial_webapp_state_State = new $TypeData().initClass({
  Ltutorial_webapp_state_State: 0
}, false, "tutorial.webapp.state.State", {
  Ltutorial_webapp_state_State: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  Ljava_io_Serializable: 1
...
$h_Ltutorial_webapp_ui_Grid.prototype = $c_Ltutorial_webapp_ui_Grid.prototype;
$c_Ltutorial_webapp_ui_Grid.prototype.productPrefix__T = (function() {
  return "Grid"
});
...
$c_Ltutorial_webapp_ui_Grid.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.Ltutorial_webapp_ui_Grid__f_container;
      break
    }
    case 1: {
      return this.Ltutorial_webapp_ui_Grid__f_tbody;
      break
    }
    case 2: {
...
$c_Ltutorial_webapp_ui_Grid.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1(this)
});
...
$c_Ltutorial_webapp_ui_Grid.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
    ...
    if ($$x1) {
      var x$3 = this.Ltutorial_webapp_ui_Grid__f_cells;
      var x$2$1 = Grid$1.Ltutorial_webapp_ui_Grid__f_cells;
      return ((x$3 === null) ? (x$2$1 === null) : x$3.equals__O__Z(x$2$1))
    } else {
      return false
    }
  } else {
...
function $as_Ltutorial_webapp_ui_Grid(obj) {
  return (((obj instanceof $c_Ltutorial_webapp_ui_Grid) || (obj === null)) ? obj : $throwClassCastException(obj, "tutorial.webapp.ui.Grid"))
}
function $isArrayOf_Ltutorial_webapp_ui_Grid(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ltutorial_webapp_ui_Grid)))
}
function $asArrayOf_Ltutorial_webapp_ui_Grid(obj, depth) {
  return (($isArrayOf_Ltutorial_webapp_ui_Grid(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ltutorial.webapp.ui.Grid;", depth))
}
var $d_Ltutorial_webapp_ui_Grid = new $TypeData().initClass({
  Ltutorial_webapp_ui_Grid: 0
}, false, "tutorial.webapp.ui.Grid", {
...
$c_Ltutorial_webapp_ui_Grid.prototype.$classData = $d_Ltutorial_webapp_ui_Grid;
/** @constructor */
function $c_Ltutorial_webapp_ui_Heading(level) {
  this.Ltutorial_webapp_ui_Heading__f_level = 0;
  this.Ltutorial_webapp_ui_Heading__f_level = level
}
$c_Ltutorial_webapp_ui_Heading.prototype = new $h_O();
$c_Ltutorial_webapp_ui_Heading.prototype.constructor = $c_Ltutorial_webapp_ui_Heading;
/** @constructor */
...
$h_Ltutorial_webapp_ui_Heading.prototype = $c_Ltutorial_webapp_ui_Heading.prototype;
$c_Ltutorial_webapp_ui_Heading.prototype.productPrefix__T = (function() {
  return "Heading"
});
$c_Ltutorial_webapp_ui_Heading.prototype.productArity__I = (function() {
  return 1
});
$c_Ltutorial_webapp_ui_Heading.prototype.productElement__I__O = (function(x$1) {
  return ((x$1 === 0) ? this.Ltutorial_webapp_ui_Heading__f_level : $m_sr_Statics$().ioobe__I__O(x$1))
});
$c_Ltutorial_webapp_ui_Heading.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1(this)
});
$c_Ltutorial_webapp_ui_Heading.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  var hash = acc;
  var data = $f_T__hashCode__I("Heading");
  acc = $m_sr_Statics$().mix__I__I__I(hash, data);
  var hash$1 = acc;
  var data$1 = this.Ltutorial_webapp_ui_Heading__f_level;
  acc = $m_sr_Statics$().mix__I__I__I(hash$1, data$1);
  var hash$2 = acc;
  return $m_sr_Statics$().finalizeHash__I__I__I(hash$2, 1)
});
$c_Ltutorial_webapp_ui_Heading.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$()._toString__s_Product__T(this)
});
$c_Ltutorial_webapp_ui_Heading.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ((x$1 instanceof $c_Ltutorial_webapp_ui_Heading)) {
    var Heading$1 = $as_Ltutorial_webapp_ui_Heading(x$1);
    return (this.Ltutorial_webapp_ui_Heading__f_level === Heading$1.Ltutorial_webapp_ui_Heading__f_level)
  } else {
    return false
  }
});
function $as_Ltutorial_webapp_ui_Heading(obj) {
  return (((obj instanceof $c_Ltutorial_webapp_ui_Heading) || (obj === null)) ? obj : $throwClassCastException(obj, "tutorial.webapp.ui.Heading"))
}
function $isArrayOf_Ltutorial_webapp_ui_Heading(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ltutorial_webapp_ui_Heading)))
}
function $asArrayOf_Ltutorial_webapp_ui_Heading(obj, depth) {
  return (($isArrayOf_Ltutorial_webapp_ui_Heading(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ltutorial.webapp.ui.Heading;", depth))
}
var $d_Ltutorial_webapp_ui_Heading = new $TypeData().initClass({
  Ltutorial_webapp_ui_Heading: 0
}, false, "tutorial.webapp.ui.Heading", {
...
$c_Ltutorial_webapp_ui_Heading.prototype.$classData = $d_Ltutorial_webapp_ui_Heading;
/** @constructor */
function $c_Ltutorial_webapp_ui_ProgressBar(container, bar) {
  this.Ltutorial_webapp_ui_ProgressBar__f_container = null;
  this.Ltutorial_webapp_ui_ProgressBar__f_bar = null;
  this.Ltutorial_webapp_ui_ProgressBar__f_container = container;
  this.Ltutorial_webapp_ui_ProgressBar__f_bar = bar
}
$c_Ltutorial_webapp_ui_ProgressBar.prototype = new $h_O();
$c_Ltutorial_webapp_ui_ProgressBar.prototype.constructor = $c_Ltutorial_webapp_ui_ProgressBar;
/** @constructor */
...
$h_Ltutorial_webapp_ui_ProgressBar.prototype = $c_Ltutorial_webapp_ui_ProgressBar.prototype;
$c_Ltutorial_webapp_ui_ProgressBar.prototype.productPrefix__T = (function() {
  return "ProgressBar"
});
$c_Ltutorial_webapp_ui_ProgressBar.prototype.productArity__I = (function() {
  return 2
});
$c_Ltutorial_webapp_ui_ProgressBar.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.Ltutorial_webapp_ui_ProgressBar__f_container;
      break
    }
    case 1: {
      return this.Ltutorial_webapp_ui_ProgressBar__f_bar;
      break
    }
    default: {
      return $m_sr_Statics$().ioobe__I__O(x$1)
...
$c_Ltutorial_webapp_ui_ProgressBar.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1(this)
});
$c_Ltutorial_webapp_ui_ProgressBar.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__Z__I(this, (-889275714), false)
});
$c_Ltutorial_webapp_ui_ProgressBar.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$()._toString__s_Product__T(this)
});
$c_Ltutorial_webapp_ui_ProgressBar.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ((x$1 instanceof $c_Ltutorial_webapp_ui_ProgressBar)) {
    var ProgressBar$1 = $as_Ltutorial_webapp_ui_ProgressBar(x$1);
    var x = this.Ltutorial_webapp_ui_ProgressBar__f_container;
    var y = ProgressBar$1.Ltutorial_webapp_ui_ProgressBar__f_container;
    if ($m_sr_BoxesRunTime$().equals__O__O__Z(x, y)) {
      var x$2 = this.Ltutorial_webapp_ui_ProgressBar__f_bar;
      var y$1 = ProgressBar$1.Ltutorial_webapp_ui_ProgressBar__f_bar;
...
function $as_Ltutorial_webapp_ui_ProgressBar(obj) {
  return (((obj instanceof $c_Ltutorial_webapp_ui_ProgressBar) || (obj === null)) ? obj : $throwClassCastException(obj, "tutorial.webapp.ui.ProgressBar"))
}
function $isArrayOf_Ltutorial_webapp_ui_ProgressBar(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ltutorial_webapp_ui_ProgressBar)))
}
function $asArrayOf_Ltutorial_webapp_ui_ProgressBar(obj, depth) {
  return (($isArrayOf_Ltutorial_webapp_ui_ProgressBar(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Ltutorial.webapp.ui.ProgressBar;", depth))
}
var $d_Ltutorial_webapp_ui_ProgressBar = new $TypeData().initClass({
  Ltutorial_webapp_ui_ProgressBar: 0
}, false, "tutorial.webapp.ui.ProgressBar", {
...
/** @constructor */
function $c_Ltutorial_webapp_puzzle_Black$() {
  /*<skip>*/
}
$c_Ltutorial_webapp_puzzle_Black$.prototype = new $h_O();
$c_Ltutorial_webapp_puzzle_Black$.prototype.constructor = $c_Ltutorial_webapp_puzzle_Black$;
/** @constructor */
function $h_Ltutorial_webapp_puzzle_Black$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_puzzle_Black$.prototype = $c_Ltutorial_webapp_puzzle_Black$.prototype;
$c_Ltutorial_webapp_puzzle_Black$.prototype.productPrefix__T = (function() {
  return "Black"
});
$c_Ltutorial_webapp_puzzle_Black$.prototype.productArity__I = (function() {
  return 0
});
$c_Ltutorial_webapp_puzzle_Black$.prototype.productElement__I__O = (function(x$1) {
  return $m_sr_Statics$().ioobe__I__O(x$1)
});
$c_Ltutorial_webapp_puzzle_Black$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1(this)
});
$c_Ltutorial_webapp_puzzle_Black$.prototype.hashCode__I = (function() {
  return 64266207
});
$c_Ltutorial_webapp_puzzle_Black$.prototype.toString__T = (function() {
  return "Black"
});
var $d_Ltutorial_webapp_puzzle_Black$ = new $TypeData().initClass({
  Ltutorial_webapp_puzzle_Black$: 0
}, false, "tutorial.webapp.puzzle.Black$", {
  Ltutorial_webapp_puzzle_Black$: 1,
  O: 1,
  Ltutorial_webapp_puzzle_Color: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Ltutorial_webapp_puzzle_Black$.prototype.$classData = $d_Ltutorial_webapp_puzzle_Black$;
var $n_Ltutorial_webapp_puzzle_Black$;
function $m_Ltutorial_webapp_puzzle_Black$() {
  if ((!$n_Ltutorial_webapp_puzzle_Black$)) {
    $n_Ltutorial_webapp_puzzle_Black$ = new $c_Ltutorial_webapp_puzzle_Black$()
  };
  return $n_Ltutorial_webapp_puzzle_Black$
}
/** @constructor */
function $c_Ltutorial_webapp_puzzle_Blue$() {
  /*<skip>*/
}
$c_Ltutorial_webapp_puzzle_Blue$.prototype = new $h_O();
$c_Ltutorial_webapp_puzzle_Blue$.prototype.constructor = $c_Ltutorial_webapp_puzzle_Blue$;
/** @constructor */
function $h_Ltutorial_webapp_puzzle_Blue$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_puzzle_Blue$.prototype = $c_Ltutorial_webapp_puzzle_Blue$.prototype;
$c_Ltutorial_webapp_puzzle_Blue$.prototype.productPrefix__T = (function() {
  return "Blue"
});
$c_Ltutorial_webapp_puzzle_Blue$.prototype.productArity__I = (function() {
  return 0
});
$c_Ltutorial_webapp_puzzle_Blue$.prototype.productElement__I__O = (function(x$1) {
  return $m_sr_Statics$().ioobe__I__O(x$1)
});
$c_Ltutorial_webapp_puzzle_Blue$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1(this)
});
$c_Ltutorial_webapp_puzzle_Blue$.prototype.hashCode__I = (function() {
  return 2073722
});
$c_Ltutorial_webapp_puzzle_Blue$.prototype.toString__T = (function() {
  return "Blue"
});
var $d_Ltutorial_webapp_puzzle_Blue$ = new $TypeData().initClass({
  Ltutorial_webapp_puzzle_Blue$: 0
}, false, "tutorial.webapp.puzzle.Blue$", {
  Ltutorial_webapp_puzzle_Blue$: 1,
  O: 1,
  Ltutorial_webapp_puzzle_Color: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Ltutorial_webapp_puzzle_Blue$.prototype.$classData = $d_Ltutorial_webapp_puzzle_Blue$;
var $n_Ltutorial_webapp_puzzle_Blue$;
function $m_Ltutorial_webapp_puzzle_Blue$() {
  if ((!$n_Ltutorial_webapp_puzzle_Blue$)) {
    $n_Ltutorial_webapp_puzzle_Blue$ = new $c_Ltutorial_webapp_puzzle_Blue$()
  };
  return $n_Ltutorial_webapp_puzzle_Blue$
}
/** @constructor */
function $c_Ltutorial_webapp_puzzle_Brown$() {
  /*<skip>*/
}
$c_Ltutorial_webapp_puzzle_Brown$.prototype = new $h_O();
$c_Ltutorial_webapp_puzzle_Brown$.prototype.constructor = $c_Ltutorial_webapp_puzzle_Brown$;
/** @constructor */
function $h_Ltutorial_webapp_puzzle_Brown$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_puzzle_Brown$.prototype = $c_Ltutorial_webapp_puzzle_Brown$.prototype;
$c_Ltutorial_webapp_puzzle_Brown$.prototype.productPrefix__T = (function() {
  return "Brown"
});
$c_Ltutorial_webapp_puzzle_Brown$.prototype.productArity__I = (function() {
  return 0
});
$c_Ltutorial_webapp_puzzle_Brown$.prototype.productElement__I__O = (function(x$1) {
  return $m_sr_Statics$().ioobe__I__O(x$1)
});
$c_Ltutorial_webapp_puzzle_Brown$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1(this)
});
$c_Ltutorial_webapp_puzzle_Brown$.prototype.hashCode__I = (function() {
  return 64459030
});
$c_Ltutorial_webapp_puzzle_Brown$.prototype.toString__T = (function() {
  return "Brown"
});
var $d_Ltutorial_webapp_puzzle_Brown$ = new $TypeData().initClass({
  Ltutorial_webapp_puzzle_Brown$: 0
}, false, "tutorial.webapp.puzzle.Brown$", {
  Ltutorial_webapp_puzzle_Brown$: 1,
  O: 1,
  Ltutorial_webapp_puzzle_Color: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Ltutorial_webapp_puzzle_Brown$.prototype.$classData = $d_Ltutorial_webapp_puzzle_Brown$;
var $n_Ltutorial_webapp_puzzle_Brown$;
function $m_Ltutorial_webapp_puzzle_Brown$() {
  if ((!$n_Ltutorial_webapp_puzzle_Brown$)) {
    $n_Ltutorial_webapp_puzzle_Brown$ = new $c_Ltutorial_webapp_puzzle_Brown$()
  };
  return $n_Ltutorial_webapp_puzzle_Brown$
}
/** @constructor */
function $c_Ltutorial_webapp_puzzle_Cyan$() {
  /*<skip>*/
}
$c_Ltutorial_webapp_puzzle_Cyan$.prototype = new $h_O();
$c_Ltutorial_webapp_puzzle_Cyan$.prototype.constructor = $c_Ltutorial_webapp_puzzle_Cyan$;
/** @constructor */
function $h_Ltutorial_webapp_puzzle_Cyan$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_puzzle_Cyan$.prototype = $c_Ltutorial_webapp_puzzle_Cyan$.prototype;
$c_Ltutorial_webapp_puzzle_Cyan$.prototype.productPrefix__T = (function() {
  return "Cyan"
});
$c_Ltutorial_webapp_puzzle_Cyan$.prototype.productArity__I = (function() {
  return 0
});
$c_Ltutorial_webapp_puzzle_Cyan$.prototype.productElement__I__O = (function(x$1) {
  return $m_sr_Statics$().ioobe__I__O(x$1)
});
$c_Ltutorial_webapp_puzzle_Cyan$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1(this)
});
$c_Ltutorial_webapp_puzzle_Cyan$.prototype.hashCode__I = (function() {
  return 2115395
});
$c_Ltutorial_webapp_puzzle_Cyan$.prototype.toString__T = (function() {
  return "Cyan"
});
var $d_Ltutorial_webapp_puzzle_Cyan$ = new $TypeData().initClass({
  Ltutorial_webapp_puzzle_Cyan$: 0
}, false, "tutorial.webapp.puzzle.Cyan$", {
  Ltutorial_webapp_puzzle_Cyan$: 1,
  O: 1,
  Ltutorial_webapp_puzzle_Color: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Ltutorial_webapp_puzzle_Cyan$.prototype.$classData = $d_Ltutorial_webapp_puzzle_Cyan$;
var $n_Ltutorial_webapp_puzzle_Cyan$;
function $m_Ltutorial_webapp_puzzle_Cyan$() {
  if ((!$n_Ltutorial_webapp_puzzle_Cyan$)) {
    $n_Ltutorial_webapp_puzzle_Cyan$ = new $c_Ltutorial_webapp_puzzle_Cyan$()
  };
  return $n_Ltutorial_webapp_puzzle_Cyan$
}
/** @constructor */
function $c_Ltutorial_webapp_puzzle_Green$() {
  /*<skip>*/
}
$c_Ltutorial_webapp_puzzle_Green$.prototype = new $h_O();
$c_Ltutorial_webapp_puzzle_Green$.prototype.constructor = $c_Ltutorial_webapp_puzzle_Green$;
/** @constructor */
function $h_Ltutorial_webapp_puzzle_Green$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_puzzle_Green$.prototype = $c_Ltutorial_webapp_puzzle_Green$.prototype;
$c_Ltutorial_webapp_puzzle_Green$.prototype.productPrefix__T = (function() {
  return "Green"
});
$c_Ltutorial_webapp_puzzle_Green$.prototype.productArity__I = (function() {
  return 0
});
$c_Ltutorial_webapp_puzzle_Green$.prototype.productElement__I__O = (function(x$1) {
  return $m_sr_Statics$().ioobe__I__O(x$1)
});
$c_Ltutorial_webapp_puzzle_Green$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1(this)
});
$c_Ltutorial_webapp_puzzle_Green$.prototype.hashCode__I = (function() {
  return 69066467
});
$c_Ltutorial_webapp_puzzle_Green$.prototype.toString__T = (function() {
  return "Green"
});
var $d_Ltutorial_webapp_puzzle_Green$ = new $TypeData().initClass({
  Ltutorial_webapp_puzzle_Green$: 0
}, false, "tutorial.webapp.puzzle.Green$", {
  Ltutorial_webapp_puzzle_Green$: 1,
  O: 1,
  Ltutorial_webapp_puzzle_Color: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Ltutorial_webapp_puzzle_Green$.prototype.$classData = $d_Ltutorial_webapp_puzzle_Green$;
var $n_Ltutorial_webapp_puzzle_Green$;
function $m_Ltutorial_webapp_puzzle_Green$() {
  if ((!$n_Ltutorial_webapp_puzzle_Green$)) {
    $n_Ltutorial_webapp_puzzle_Green$ = new $c_Ltutorial_webapp_puzzle_Green$()
  };
  return $n_Ltutorial_webapp_puzzle_Green$
}
/** @constructor */
function $c_Ltutorial_webapp_puzzle_MultiColor$() {
  /*<skip>*/
}
$c_Ltutorial_webapp_puzzle_MultiColor$.prototype = new $h_O();
$c_Ltutorial_webapp_puzzle_MultiColor$.prototype.constructor = $c_Ltutorial_webapp_puzzle_MultiColor$;
/** @constructor */
function $h_Ltutorial_webapp_puzzle_MultiColor$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_puzzle_MultiColor$.prototype = $c_Ltutorial_webapp_puzzle_MultiColor$.prototype;
$c_Ltutorial_webapp_puzzle_MultiColor$.prototype.productPrefix__T = (function() {
  return "MultiColor"
});
$c_Ltutorial_webapp_puzzle_MultiColor$.prototype.productArity__I = (function() {
  return 0
});
$c_Ltutorial_webapp_puzzle_MultiColor$.prototype.productElement__I__O = (function(x$1) {
  return $m_sr_Statics$().ioobe__I__O(x$1)
});
$c_Ltutorial_webapp_puzzle_MultiColor$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1(this)
});
$c_Ltutorial_webapp_puzzle_MultiColor$.prototype.hashCode__I = (function() {
  return (-1077894710)
});
$c_Ltutorial_webapp_puzzle_MultiColor$.prototype.toString__T = (function() {
  return "MultiColor"
});
var $d_Ltutorial_webapp_puzzle_MultiColor$ = new $TypeData().initClass({
  Ltutorial_webapp_puzzle_MultiColor$: 0
}, false, "tutorial.webapp.puzzle.MultiColor$", {
  Ltutorial_webapp_puzzle_MultiColor$: 1,
  O: 1,
  Ltutorial_webapp_puzzle_Color: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Ltutorial_webapp_puzzle_MultiColor$.prototype.$classData = $d_Ltutorial_webapp_puzzle_MultiColor$;
var $n_Ltutorial_webapp_puzzle_MultiColor$;
function $m_Ltutorial_webapp_puzzle_MultiColor$() {
  if ((!$n_Ltutorial_webapp_puzzle_MultiColor$)) {
    $n_Ltutorial_webapp_puzzle_MultiColor$ = new $c_Ltutorial_webapp_puzzle_MultiColor$()
  };
  return $n_Ltutorial_webapp_puzzle_MultiColor$
}
/** @constructor */
function $c_Ltutorial_webapp_puzzle_Orange$() {
  /*<skip>*/
}
$c_Ltutorial_webapp_puzzle_Orange$.prototype = new $h_O();
$c_Ltutorial_webapp_puzzle_Orange$.prototype.constructor = $c_Ltutorial_webapp_puzzle_Orange$;
/** @constructor */
function $h_Ltutorial_webapp_puzzle_Orange$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_puzzle_Orange$.prototype = $c_Ltutorial_webapp_puzzle_Orange$.prototype;
$c_Ltutorial_webapp_puzzle_Orange$.prototype.productPrefix__T = (function() {
  return "Orange"
});
$c_Ltutorial_webapp_puzzle_Orange$.prototype.productArity__I = (function() {
  return 0
});
$c_Ltutorial_webapp_puzzle_Orange$.prototype.productElement__I__O = (function(x$1) {
  return $m_sr_Statics$().ioobe__I__O(x$1)
});
$c_Ltutorial_webapp_puzzle_Orange$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1(this)
});
$c_Ltutorial_webapp_puzzle_Orange$.prototype.hashCode__I = (function() {
  return (-1924984242)
});
$c_Ltutorial_webapp_puzzle_Orange$.prototype.toString__T = (function() {
  return "Orange"
});
var $d_Ltutorial_webapp_puzzle_Orange$ = new $TypeData().initClass({
  Ltutorial_webapp_puzzle_Orange$: 0
}, false, "tutorial.webapp.puzzle.Orange$", {
  Ltutorial_webapp_puzzle_Orange$: 1,
  O: 1,
  Ltutorial_webapp_puzzle_Color: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Ltutorial_webapp_puzzle_Orange$.prototype.$classData = $d_Ltutorial_webapp_puzzle_Orange$;
var $n_Ltutorial_webapp_puzzle_Orange$;
function $m_Ltutorial_webapp_puzzle_Orange$() {
  if ((!$n_Ltutorial_webapp_puzzle_Orange$)) {
    $n_Ltutorial_webapp_puzzle_Orange$ = new $c_Ltutorial_webapp_puzzle_Orange$()
  };
  return $n_Ltutorial_webapp_puzzle_Orange$
}
/** @constructor */
function $c_Ltutorial_webapp_puzzle_Pink$() {
  /*<skip>*/
}
$c_Ltutorial_webapp_puzzle_Pink$.prototype = new $h_O();
$c_Ltutorial_webapp_puzzle_Pink$.prototype.constructor = $c_Ltutorial_webapp_puzzle_Pink$;
/** @constructor */
function $h_Ltutorial_webapp_puzzle_Pink$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_puzzle_Pink$.prototype = $c_Ltutorial_webapp_puzzle_Pink$.prototype;
$c_Ltutorial_webapp_puzzle_Pink$.prototype.productPrefix__T = (function() {
  return "Pink"
});
$c_Ltutorial_webapp_puzzle_Pink$.prototype.productArity__I = (function() {
  return 0
});
$c_Ltutorial_webapp_puzzle_Pink$.prototype.productElement__I__O = (function(x$1) {
  return $m_sr_Statics$().ioobe__I__O(x$1)
});
$c_Ltutorial_webapp_puzzle_Pink$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1(this)
});
$c_Ltutorial_webapp_puzzle_Pink$.prototype.hashCode__I = (function() {
  return 2487702
});
$c_Ltutorial_webapp_puzzle_Pink$.prototype.toString__T = (function() {
  return "Pink"
});
var $d_Ltutorial_webapp_puzzle_Pink$ = new $TypeData().initClass({
  Ltutorial_webapp_puzzle_Pink$: 0
}, false, "tutorial.webapp.puzzle.Pink$", {
  Ltutorial_webapp_puzzle_Pink$: 1,
  O: 1,
  Ltutorial_webapp_puzzle_Color: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Ltutorial_webapp_puzzle_Pink$.prototype.$classData = $d_Ltutorial_webapp_puzzle_Pink$;
var $n_Ltutorial_webapp_puzzle_Pink$;
function $m_Ltutorial_webapp_puzzle_Pink$() {
  if ((!$n_Ltutorial_webapp_puzzle_Pink$)) {
    $n_Ltutorial_webapp_puzzle_Pink$ = new $c_Ltutorial_webapp_puzzle_Pink$()
  };
  return $n_Ltutorial_webapp_puzzle_Pink$
}
/** @constructor */
function $c_Ltutorial_webapp_puzzle_Purple$() {
  /*<skip>*/
}
$c_Ltutorial_webapp_puzzle_Purple$.prototype = new $h_O();
$c_Ltutorial_webapp_puzzle_Purple$.prototype.constructor = $c_Ltutorial_webapp_puzzle_Purple$;
/** @constructor */
function $h_Ltutorial_webapp_puzzle_Purple$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_puzzle_Purple$.prototype = $c_Ltutorial_webapp_puzzle_Purple$.prototype;
$c_Ltutorial_webapp_puzzle_Purple$.prototype.productPrefix__T = (function() {
  return "Purple"
});
$c_Ltutorial_webapp_puzzle_Purple$.prototype.productArity__I = (function() {
  return 0
});
$c_Ltutorial_webapp_puzzle_Purple$.prototype.productElement__I__O = (function(x$1) {
  return $m_sr_Statics$().ioobe__I__O(x$1)
});
$c_Ltutorial_webapp_puzzle_Purple$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1(this)
});
$c_Ltutorial_webapp_puzzle_Purple$.prototype.hashCode__I = (function() {
  return (-1893076004)
});
$c_Ltutorial_webapp_puzzle_Purple$.prototype.toString__T = (function() {
  return "Purple"
});
var $d_Ltutorial_webapp_puzzle_Purple$ = new $TypeData().initClass({
  Ltutorial_webapp_puzzle_Purple$: 0
}, false, "tutorial.webapp.puzzle.Purple$", {
  Ltutorial_webapp_puzzle_Purple$: 1,
  O: 1,
  Ltutorial_webapp_puzzle_Color: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Ltutorial_webapp_puzzle_Purple$.prototype.$classData = $d_Ltutorial_webapp_puzzle_Purple$;
var $n_Ltutorial_webapp_puzzle_Purple$;
function $m_Ltutorial_webapp_puzzle_Purple$() {
  if ((!$n_Ltutorial_webapp_puzzle_Purple$)) {
    $n_Ltutorial_webapp_puzzle_Purple$ = new $c_Ltutorial_webapp_puzzle_Purple$()
  };
  return $n_Ltutorial_webapp_puzzle_Purple$
}
/** @constructor */
function $c_Ltutorial_webapp_puzzle_Red$() {
  /*<skip>*/
}
$c_Ltutorial_webapp_puzzle_Red$.prototype = new $h_O();
$c_Ltutorial_webapp_puzzle_Red$.prototype.constructor = $c_Ltutorial_webapp_puzzle_Red$;
/** @constructor */
function $h_Ltutorial_webapp_puzzle_Red$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_puzzle_Red$.prototype = $c_Ltutorial_webapp_puzzle_Red$.prototype;
$c_Ltutorial_webapp_puzzle_Red$.prototype.productPrefix__T = (function() {
  return "Red"
});
$c_Ltutorial_webapp_puzzle_Red$.prototype.productArity__I = (function() {
  return 0
});
$c_Ltutorial_webapp_puzzle_Red$.prototype.productElement__I__O = (function(x$1) {
  return $m_sr_Statics$().ioobe__I__O(x$1)
});
$c_Ltutorial_webapp_puzzle_Red$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1(this)
});
$c_Ltutorial_webapp_puzzle_Red$.prototype.hashCode__I = (function() {
  return 82033
});
$c_Ltutorial_webapp_puzzle_Red$.prototype.toString__T = (function() {
  return "Red"
});
var $d_Ltutorial_webapp_puzzle_Red$ = new $TypeData().initClass({
  Ltutorial_webapp_puzzle_Red$: 0
}, false, "tutorial.webapp.puzzle.Red$", {
  Ltutorial_webapp_puzzle_Red$: 1,
  O: 1,
  Ltutorial_webapp_puzzle_Color: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Ltutorial_webapp_puzzle_Red$.prototype.$classData = $d_Ltutorial_webapp_puzzle_Red$;
var $n_Ltutorial_webapp_puzzle_Red$;
function $m_Ltutorial_webapp_puzzle_Red$() {
  if ((!$n_Ltutorial_webapp_puzzle_Red$)) {
...
$c_Ltutorial_webapp_puzzle_White$.prototype = new $h_O();
$c_Ltutorial_webapp_puzzle_White$.prototype.constructor = $c_Ltutorial_webapp_puzzle_White$;
/** @constructor */
function $h_Ltutorial_webapp_puzzle_White$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_puzzle_White$.prototype = $c_Ltutorial_webapp_puzzle_White$.prototype;
$c_Ltutorial_webapp_puzzle_White$.prototype.productPrefix__T = (function() {
  return "White"
});
$c_Ltutorial_webapp_puzzle_White$.prototype.productArity__I = (function() {
  return 0
});
$c_Ltutorial_webapp_puzzle_White$.prototype.productElement__I__O = (function(x$1) {
  return $m_sr_Statics$().ioobe__I__O(x$1)
});
$c_Ltutorial_webapp_puzzle_White$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1(this)
});
$c_Ltutorial_webapp_puzzle_White$.prototype.hashCode__I = (function() {
  return 83549193
});
$c_Ltutorial_webapp_puzzle_White$.prototype.toString__T = (function() {
  return "White"
});
var $d_Ltutorial_webapp_puzzle_White$ = new $TypeData().initClass({
  Ltutorial_webapp_puzzle_White$: 0
}, false, "tutorial.webapp.puzzle.White$", {
  Ltutorial_webapp_puzzle_White$: 1,
  O: 1,
  Ltutorial_webapp_puzzle_Color: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Ltutorial_webapp_puzzle_White$.prototype.$classData = $d_Ltutorial_webapp_puzzle_White$;
var $n_Ltutorial_webapp_puzzle_White$;
function $m_Ltutorial_webapp_puzzle_White$() {
  if ((!$n_Ltutorial_webapp_puzzle_White$)) {
    $n_Ltutorial_webapp_puzzle_White$ = new $c_Ltutorial_webapp_puzzle_White$()
  };
  return $n_Ltutorial_webapp_puzzle_White$
}
/** @constructor */
function $c_Ltutorial_webapp_puzzle_Yellow$() {
  /*<skip>*/
}
$c_Ltutorial_webapp_puzzle_Yellow$.prototype = new $h_O();
$c_Ltutorial_webapp_puzzle_Yellow$.prototype.constructor = $c_Ltutorial_webapp_puzzle_Yellow$;
/** @constructor */
function $h_Ltutorial_webapp_puzzle_Yellow$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_puzzle_Yellow$.prototype = $c_Ltutorial_webapp_puzzle_Yellow$.prototype;
$c_Ltutorial_webapp_puzzle_Yellow$.prototype.productPrefix__T = (function() {
  return "Yellow"
});
$c_Ltutorial_webapp_puzzle_Yellow$.prototype.productArity__I = (function() {
  return 0
});
$c_Ltutorial_webapp_puzzle_Yellow$.prototype.productElement__I__O = (function(x$1) {
  return $m_sr_Statics$().ioobe__I__O(x$1)
});
$c_Ltutorial_webapp_puzzle_Yellow$.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1(this)
});
$c_Ltutorial_webapp_puzzle_Yellow$.prototype.hashCode__I = (function() {
  return (-1650372460)
});
$c_Ltutorial_webapp_puzzle_Yellow$.prototype.toString__T = (function() {
  return "Yellow"
});
var $d_Ltutorial_webapp_puzzle_Yellow$ = new $TypeData().initClass({
  Ltutorial_webapp_puzzle_Yellow$: 0
}, false, "tutorial.webapp.puzzle.Yellow$", {
  Ltutorial_webapp_puzzle_Yellow$: 1,
  O: 1,
  Ltutorial_webapp_puzzle_Color: 1,
  s_Product: 1,
  s_Equals: 1,
...
$c_Ltutorial_webapp_puzzle_Yellow$.prototype.$classData = $d_Ltutorial_webapp_puzzle_Yellow$;
var $n_Ltutorial_webapp_puzzle_Yellow$;
function $m_Ltutorial_webapp_puzzle_Yellow$() {
  if ((!$n_Ltutorial_webapp_puzzle_Yellow$)) {
    $n_Ltutorial_webapp_puzzle_Yellow$ = new $c_Ltutorial_webapp_puzzle_Yellow$()
  };
  return $n_Ltutorial_webapp_puzzle_Yellow$
}
